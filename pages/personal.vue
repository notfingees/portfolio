...
<br></br>View the project at <a href='https://www.inwriting.io' target='_blank'>https://www.inwriting.io</a></p>
        ...
        <div class="image">
        <nuxt-img format="webp" placeholder class="main" src="/projects/inwriting/slides.png"></nuxt-img format="webp" placeholder>
        ...
        <div class="features">
          ...
          <div class="feature_wrapper">
            ...
            <nuxt-img format="webp" placeholder class="feature_image" src="/projects/inwriting/api.png"></nuxt-img format="webp" placeholder>
            </div>
          ...
          <div class="feature_wrapper">
            <div class="feature_image_wrapper">
            <nuxt-img format="webp" placeholder class="feature_image" src="/projects/inwriting/marketplace.png"></nuxt-img format="webp" placeholder>
            </div>
            <div class="feature_description">
          ...
          <div class="feature_wrapper">
            <div class="feature_image_wrapper">
            <nuxt-img format="webp" placeholder class="feature_image" src="/projects/inwriting/seo.png"></nuxt-img format="webp" placeholder>
            </div>
            <div class="feature_description">
          ...
          <div class="feature_wrapper">
            <div class="feature_image_wrapper">
            <nuxt-img format="webp" placeholder class="feature_image" src="/projects/inwriting/loading.gif"></nuxt-img format="webp" placeholder>
            </div>
            <div class="feature_description">
