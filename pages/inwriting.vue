  ...
  <div id="app">
    ...
    <section id="intro">
      <div class="intro">
        ...
        <h1 class="title">In Writing</h1>
        <p class="intro_description">A decentralized, scalable, and environmentally-friendly text NFT marketplace I cofounded, designed, and built to make NFTs accessible to writers and authors. Users can mint, read, buy, sell, and trade text NFTs easily on the Polygon and Ethereum blockchains.
<br></br>View the project at <a href='https://www.inwriting.io' target='_blank'>https://www.inwriting.io</a></p>

        <div class="image">
        <nuxt-img format="webp" placeholder class="main" src="/projects/inwriting/slides.png" alt="4 pictures of the In Writing UI on both desktop and mobile"></nuxt-img format="webp" placeholder>
        <p class="caption">Top left to bottom right: The landing, writing/minting, about, and explore pages of In Writing</p>
        </div>
        ...
        <div class="technology_used">
          ...
          <ul>
            ...
            <li>web3py, web3.js (Frontend, Backend)</li>
            <li>Chai (Testing)</li>
            <li>Hardhat (Testing)</li>
            <li>Mocha (Testing)</li>
          </ul>
          </div>
          ...
          <ul>
            <li>Polygonscan API (Backend)</li>
            <li>Alchemy API (Backend)</li>
            <li>LAMP (Backend stack)</li>
            <li>AWS Lightsail (Backend)</li>
            <li>AWS Amplify (Hosting)</li>
            <li>AWS Cloudfront (Hosting)</li>
        ...
        <div class="features">
          ...
          <div class="feature_wrapper">
            ...
            <nuxt-img format="webp" placeholder class="feature_image" src="/projects/inwriting/api.png" alt="demonstration of api interaction with in writing using postman"></nuxt-img format="webp" placeholder>
            </div>
            <div class="feature_description">
              <h3>RESTful API</h3>
              <p class="feature_text">I designed the database and built a robust RESTful API for our frontend, backend, and users to access data regarding In Writing blockchain activity and NFT details. 
                It's written in PHP, and interacts with a MySQL database. <br></br>When the backend processes data, it's sanitized at every step and the database is only updated through prepared statements. 
                In the frontend, data is constantly validated with both the backend and blockchain to prevent the user from making irreparable mistakes and accidental errors.
              </p>
          ...
          <div class="feature_wrapper">
            <div class="feature_image_wrapper">
            <nuxt-img format="webp" placeholder class="feature_image" src="/projects/inwriting/marketplace.png" alt="demonstration of making a purchase on the in writing website (which interfaces with the in writing smart contract)"></nuxt-img format="webp" placeholder>
            </div>
            <div class="feature_description">
              <h3>Decentralized Marketplace</h3>
              <p class="feature_text">My cofounder and I pair programmed the decentralized marketplace that powers In Writing on the Polygon network and Ethereum blockchain. I also wrote and automated the unit tests using Mocha, Chai, and Hardhat to ensure there weren't any security vulnerabilities within the contract.<br></br>
              Users can mint, list, buy, sell, and read text NFTs on In Writing or by interacting with the marketplace smart contract directly. 
              </p>
          ...
          <div class="feature_wrapper">
            <div class="feature_image_wrapper">
            <nuxt-img format="webp" placeholder class="feature_image" src="/projects/inwriting/seo.png" alt="demonstration of high SEO and performance scores of in writing via google lighthouse"></nuxt-img format="webp" placeholder>
            </div>
            <div class="feature_description">
              <h3>SEO and Page Load Optimization</h3>
              <p class="feature_text">I learned SEO best practices and page-loading optimization techniques to maximize the SEO and Javascript performance of In Writing (barring some inevitable conflicts with text art and illegible font sizes). 
                These practices included lazy loading, backlinks, sitemap generation, and how to use condent distribution networks such as AWS CloudFront.
              </p>
          ...
          <div class="feature_wrapper">
            <div class="feature_image_wrapper">
            <nuxt-img format="webp" placeholder class="feature_image" src="/projects/inwriting/loading.gif" alt="gif of in writing's loading animation"></nuxt-img format="webp" placeholder>
            </div>
            <div class="feature_description">
              <h3>Custom Loading Animation</h3>
              <p class="feature_text">I implemented a 3D rotating cube in vanilla Javascript and rendered it using ASCII symbols for In Writing's loading animation. 
              </p>
